...
public class ListAppointmentControllerTest {
    ...
    void retrieveAllAppointment_ReturnsListOfAppointments() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].aptName").value("Checkup"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].aptType").value("Dentist"))
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].aptName").value("Dentist Visit"))
                .andExpect(MockMvcResultMatchers.jsonPath("$[1].aptType").value("Orthodontist"))
